...
[IO Mapping](io-map.en.md) for the complete mapping.
...
[Design Selection, Clock, and Reset Control](design-control.en.md).
...
See the [user guide](user-guide.en.md) and [registration notes](user-design-registration.en.md).
...
normal. See [Simulation and Regression](simulation-regression.en.md) for waveform
