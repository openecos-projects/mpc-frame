...
CI and local user workflows both require 5.050 for consistent, reproducible
results. The root Makefile probes nonessential warning options before using them.
